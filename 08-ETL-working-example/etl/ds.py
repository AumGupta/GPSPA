...
def read_parquet(fname: str,) -> pd.DataFrame:
    ...
    Args:
        fname (str): the name of the Parquet file
    ...
    try:
        ...
        die(f"read_parquet: {e}")
    return df


def read_shp(fname: str) -> gpd.GeoDataFrame:
...
def write_csv(df: pd.DataFrame, fname: str, sep: str = ",", quotechar: str = '"') -> None:
